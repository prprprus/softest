...
(async () => {
  ...
  element = await page.$x('/html/body/div/div[4]/div[2]/div/div/ul[2]/li[171]/a/img[1]');
  await element[0].click();
  await page.waitFor(5000);
  pages = await browser.pages();
  page = pages[pages.length - 1];
  ...
  element = await page.$x('/html/body/div[1]/div[5]/div[1]/div/div[2]/div[1]/ul[1]/li[1]/a[1]');
  await element[0].click();
  await page.waitFor(5000);
  pages = await browser.pages();
  page = pages[pages.length - 1];
  ...
  await page.goto('https://datatracker.ietf.org/doc/rfc1627/', {
    waitUntil: 'networkidle0',
  });
  await page.waitFor(1000);
