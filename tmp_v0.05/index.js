...
(async () => {
  ...
  element = await page.$x('/html/body/div/div[4]/div[2]/div/div/ul[2]/li[167]/a/img[1]');
  await element[0].click();
  await page.waitFor(3000);
  pages = await browser.pages();
  page = pages[pages.length - 1];
  ...
  element = await page.$x('/html/body/div[1]/div[5]/div[2]/div[1]/div[2]/ul/li[2]/a[2]');
  await element[0].click();
  await page.waitFor(3000);
  pages = await browser.pages();
  page = pages[pages.length - 1];
  ...
  await page.goto('https://www.taptap.com/app/139184/review', {
    waitUntil: 'networkidle0',
  });
  await page.waitFor(500);

  await page.goto('https://www.taptap.com/app/140175', {
    waitUntil: 'networkidle0',
  });
  await page.waitFor(500);
